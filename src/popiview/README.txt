...
>>> keywordanalyzer.get_keyword_cloud(start_time=0, end_time=10000)
[('cool', 60.0),
 ('page', 40.0)]
...
>>> keywordanalyzer.get_keyword_cloud(start_time=0, end_time=10000, limit=1)
[('cool', 100.0)]

We can adjust the percentage by setting minimum and/or maximum values:

>>> keywordanalyzer.get_keyword_cloud(start_time=0, end_time=10000, 
...     minimum_pct=25, maximum_pct=175)
[('cool', 115.0),
 ('page', 85.0)]
